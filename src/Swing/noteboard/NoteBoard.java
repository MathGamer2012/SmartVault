 ...
 */
public class NoteBoard extends javax.swing.JPanel {

    /**
     * Creates new form NoteBoard
     */
    public NoteBoard() {
        initComponents();
    ...
    public void addNoteBoard(ModelNoteBoard data) {
        JLabel title = new JLabel(data.getTime());
